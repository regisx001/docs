...
<article class="">
	<header class="">
		...
		<h1 class="text-3xl font-bold tracking-tight text-slate-900">Quick start guide</h1>
	</header>
	...
	<h3 class="mt-16 text-base font-bold tracking-tight text-slate-900">Get set up quickly</h3>
	...
	<ul class="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2">
		<li>
			...
			>
				<h4 class="font-bold tracking-tight text-slate-900">Connect your GitHub account</h4>

				<p class="text-slate-600">What you need to know before connecting your GitHub account</p>
			</a>
		</li>
		...
		<li>
			<a
				...
				class="block px-6 py-4 border rounded bg-slate-50 border-slate-100 hover:bg-white"
			>
				<h4 class="font-bold tracking-tight text-slate-900">Add your first content type</h4>

				<p class="text-slate-600">Learn what content types are in Spinal</p>
			</a>
		</li>
		...
		<li class="">
			<a
				...
				class="block px-6 py-4 border rounded bg-slate-50 border-slate-100 hover:bg-white"
			>
				<h4 class="font-bold tracking-tight text-slate-900">Invite your first team member</h4>

				<p class="text-slate-600">You write your best marketing content with your team</p>
			</a>
		</li>
		...
		<li class="">
			<a
				...
				class="block px-6 py-4 border rounded bg-slate-50 border-slate-100 hover:bg-white"
			>
				<h4 class="font-bold tracking-tight text-slate-900">Publish your content</h4>

				<p class="text-slate-600">Publishing with Spinal is really just one click of a button</p>
			</a>
		</li>
	</ul>
