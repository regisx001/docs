		...
		<ul role="list" class="-ml-0.5 h-[calc(100vh-4.5rem)] overflow-y-auto py-7 pl-0.5 space-y-8">
			<li>
				...
				<ul role="list" class="pl-3 mt-3 space-y-2">
					<li>
						<a href="#ss" class="text-slate-900 hover:text-slate-800"> Quick start guide </a>
					</li>

					<li>
						<a href="#ss" class="text-slate-600 hover:text-slate-800"> How does Spinal work? </a>
					</li>
				</ul>
			</li>

			<li>
				<h3 class="font-semibold tracking-tight text-slate-900">Content Types</h3>

				<ul role="list" class="pl-3 mt-3 space-y-2">
					<li>
						<a href="#sss" class="text-slate-600 hover:text-slate-800"> What are content types? </a>
					</li>

					<li>
						<a href="#sss" class="text-slate-600 hover:text-slate-800">
			...
			<li>
				...
				<ul role="list" class="pl-3 mt-3 space-y-2">
					...
					<li>
						<a href="#ss" class="text-slate-600 hover:text-slate-800"> Previewing content </a>
					</li>
				</ul>
			</li>
		</ul>
